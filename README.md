...
Cluster target samples → reverse a pretrained FM model into a per-cluster Gaussian source → cluster-wise optimal-transport fine-tuning → straighter flows and faster sampling.
